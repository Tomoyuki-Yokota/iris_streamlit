...
img = Image.open('/Users/yokotatomoyuki/Desktop/streamlit/pexels-karolina-grabowska-6333507.jpg')
st.image(img,caption = 'Laugh man' , use_column_width = True)
...
# テキスト入力による値の動的変更
text = st.sidebar.text_input('あなたの好きな芸能人を教えて下さい。')
